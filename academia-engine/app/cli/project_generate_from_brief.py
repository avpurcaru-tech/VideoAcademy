...
def main():
    ...
    try:
        ...
        if not args.confirm:
            local_episode=EpisodeGenerationService(DeterministicEpisodeGenerator())
        ...
        episode_service=EpisodeGenerationService(EpisodeGeneratorRegistry().resolve(args.episode_generator))
